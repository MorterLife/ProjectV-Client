	...
	public static NpcComposite getNpcComposite(final int i) {
		...
		try {
			...
			if (i == 1787) {
				...
				npcdef_1_.actions[4] = "Zanaris";
			}
			if (i == 276) {
				npcdef_1_.name = "<img=34>Guide";
				npcdef_1_.actions = new String[5];
			...
			if (i == 315) {
				...
				npcdef_1_.actions = new String[5];
				npcdef_1_.actions[0] = "Talk to";
				npcdef_1_.actions[1] = "BM Shop";
				npcdef_1_.actions[2] = "Hide-streaks";
				npcdef_1_.actions[3] = "Skull";
			}
			if (i == 637) {
			...
			if (i == 6904 || i == 535) {
				npcdef_1_.name = "Shop";
				npcdef_1_.actions = new String[5];
				npcdef_1_.actions[0] = "<img=44>Melee Weapon";
				npcdef_1_.actions[3] = "<img=43>Melee Armor";
			}
			if (i == 7492) {
				npcdef_1_.name = "Shop";
				npcdef_1_.actions = new String[5];
